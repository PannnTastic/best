        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-4">
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex flex-col sm:flex-row gap-6 items-start sm:items-center">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-gray-500 text-sm mb-2">{{ $product->category->nama_kategori ?? 'Umum' }}</p>
            ...
            <div class="lg:col-span-1">
                <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 sticky top-24">
                    ...
                    <a href="{{ route('checkout') }}" class="block w-full bg-green-500 hover:bg-green-600 text-white font-bold py-3 rounded-lg transition mb-4 text-center flex items-center justify-center gap-2">
