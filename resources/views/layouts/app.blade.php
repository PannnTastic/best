    ...
    <header class="bg-white border-b border-gray-100 sticky top-0 z-50">
        <div class="container mx-auto px-4 h-20 flex items-center justify-between">
            ...
            <nav class="hidden md:flex gap-2 items-center text-sm font-medium">
                ...
                <span class="text-orange-400">/</span>
                <a href="{{ route('contact') }}" class="px-4 py-2 rounded {{ request()->routeIs('contact') ? 'bg-[#0F3075] text-white' : 'text-[#0F3075] hover:bg-gray-100' }}">
                    CONTACT US
                </a>
            </nav>
            ...
            <div class="flex items-center gap-4">
                <a href="{{ route('cart.index') }}" class="relative text-[#0F3075] hover:text-blue-800">
                    ...
                    @auth
                        @php
                            ...
                            $totalItems = $cart ? $cart->products->sum('pivot.jumlah_produk') : 0;
                        @endphp
                        @if($totalItems > 0)
                ...
                @guest
                    ...
                    <a href="{{ route('login') }}" class="text-[#0F3075] hover:text-blue-800" title="Masuk">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                @else
                    ...
                    <div class="relative" x-data="{ open: false }" @click.away="open = false">
                        <button @click="open = !open" class="flex items-center gap-2 text-[#0F3075] hover:text-blue-800 focus:outline-none">
                            <div class="w-8 h-8 bg-[#0F3075] rounded-full flex items-center justify-center text-white text-sm font-bold">
                                {{ substr(auth()->user()->nama_lengkap, 0, 1) }}
                            </div>
                            <span class="hidden md:block text-sm font-medium">{{ auth()->user()->nama_lengkap }}</span>
                        ...
                        <div x-show="open" 
                            ...
                            <a href="{{ route('cart.index') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
                                <span class="flex items-center gap-2">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" />
                                    </svg>
                ...
                <div>
                    ...
                    <ul class="space-y-4 text-sm text-gray-300">
                        ...
                        <li class="flex gap-3">
                            ...
                            <span>Jl. Villa Jasmine 1, Salam, Suko, Kec. Sidoarjo, Kabupaten Sidoarjo, Jawa Timur 61224</span>
                        </li>
                    </ul>
                </div>
            </div>
